...
-- v2: drops existing policies first to prevent "already exists" errors on re-runs.
...
DROP POLICY IF EXISTS "Users can read own mentor conversations" ON mentor_conversations;
DROP POLICY IF EXISTS "Users can insert own mentor conversations" ON mentor_conversations;
